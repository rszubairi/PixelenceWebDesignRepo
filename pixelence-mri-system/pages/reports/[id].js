        ...
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-sm text-gray-600">The report with ID &quot;{id}&quot; could not be found.</p>
              <div className="mt-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-3">
              ...
              <Button onClick={() => router.push(`/images/${report.jobId}`)}>
                View Images
              </Button>
            ...
            <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Generated on {new Date(report.createdAt).toLocaleString()}</p>
                </div>
                ...
                <div>
                  ...
                  <dl className="space-y-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm text-gray-900 mt-1">{report.dicomFile}</dd>
                    </div>
                  </dl>
                </div>
              </div>
